...
namespace ChapreEuler.Problems._11
{
    class ProductGrid : ITestable
    {
        public void Test()
        {
...
01 70 54 71 83 51 54 69 16 92 33 48 61 43 52 01 89 19 67 48";
            ...
            for (int i = 0; i < grid.Length; i++)
            {
                ...
                {
                    maxProd = bottom;
                    Console.WriteLine($"bottom <{i}> ---> {maxProd}");
                }
        ...
        long GetRightProduct(int[] grid, int startIndex, int count)
        {
            long prod = 1;
        ...
        long GetBottomProduct(int[] grid, int startIndex, int count)
        {
            long prod = 1;
            for (int i = 0; i < count; i++)
            {
                var index = startIndex + i * 20;
                if (index >= grid.Length)
                    return 0;
                prod *= grid[index];
            }
